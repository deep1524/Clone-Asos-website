...
let navbar =()=>{
    ...
    ><img
      ...
      alt=""
  /></a>
  <div id="nav_women">WOMEN</div>
  <div id="nav_men">MEN</div>
  <div id="search_box">
    <input
      type="text"
      id="search"
      ...
      <li id="A">
        ...
        <div class="dropdown2">
          <ul>
            <li>
              <div>
                <a href="" style="color: rgb(40, 38, 38)"> Sign In</a> |
                <a href="" style="color: rgb(40, 38, 38)"> Join</a>
              </div>
